...
QT_MOC_LITERAL(1, 8, 14), // "queryPixSignal"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "myLabel\0queryPixSignal\0"
};
...
void myLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (myLabel::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&myLabel::queryPixSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void myLabel::queryPixSignal(int _t1, int _t2)
{
